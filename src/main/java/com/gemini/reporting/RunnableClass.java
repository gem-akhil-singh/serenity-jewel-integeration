...
import com.gemini.utils.ApiInvocation;
import com.gemini.utils.ApiInvocationImpl;
import com.gemini.utils.Request;
import com.gemini.utils.Response;
import com.gemini.utils.CommonUtils;
    ...
    public void updateRequestPayloadForScreenShot() throws ExecutionException, InterruptedException {
        ...
        for (int i = 0; i < stepsArray.size(); i++) {
            ...
            if (stepObject.has("ScreenShot")) {
               String screenShotLocalPath =  stepObject.get("ScreenShot").getAsString();
